...
class LendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lend" do
    assert_difference('Lend.count') do
      post lends_url, params: { lend: { deliver_date: @lend.deliver_date, loan_date: @lend.loan_date, movie_id: @lend.movie_id, user_id: @lend.user_id, value: @lend.value } }
    end
  ...
  test "should update lend" do
    patch lend_url(@lend), params: { lend: { deliver_date: @lend.deliver_date, loan_date: @lend.loan_date, movie_id: @lend.movie_id, user_id: @lend.user_id, value: @lend.value } }
